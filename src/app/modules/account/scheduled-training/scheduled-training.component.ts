...
@Component({
  selector: 'app-scheduled-training',
  templateUrl: './scheduled-training.component.html',
  styleUrls: ['./scheduled-training.component.scss'],
  encapsulation: ViewEncapsulation.None

})
export class ScheduledTrainingComponent implements OnInit {
