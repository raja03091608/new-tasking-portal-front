    ...
    function generateImage() {
      signatureImage = document.getElementById("userSignature");
      ...
      APPLICANT_SIGNATURE=signatureCanvas.toDataURL("image/jpeg");
      signatureImage.src = signatureCanvas.toDataURL("image/jpeg");
      signatureComponent.afterSignatureCollected(signatureCanvas.toDataURL("image/jpeg"));
    }
